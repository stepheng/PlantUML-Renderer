...
1. Download `vscode-plantuml-renderer-0.1.2.vsix` from the [latest release](https://github.com/stepheng/PlantUML-Renderer/releases/latest)
2. Install it:
   ```bash
   code --install-extension vscode-plantuml-renderer-0.1.2.vsix
   ```
